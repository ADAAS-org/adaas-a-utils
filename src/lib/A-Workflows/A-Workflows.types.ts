 ...
 */
export type A_TYPES__WorkflowValueSource =
    | { value: any; from?: never; fn?: never; args?: never }
    | { from: string; value?: never; fn?: never; args?: never }
    | {
 ...
 * ```
 */
export type A_TYPES__WorkflowRemap = Record<string, A_TYPES__WorkflowValueSource>;
 ...
 */
export type A_TYPES__WorkflowCondition = {
 ...
 */
export type A_TYPES__FeatureLoaderStep = {
    /**
 ...
 */
export type A_TYPES__FeatureLoaderConfig = {
 ...
 */
export type A_TYPES__WorkflowStep = {
 ...
 */
export type A_TYPES__WorkflowDefinition = {
 ...
 */
export type A_TYPES__Workflow_Init = {
 ...
 */
export type A_TYPES__WorkflowContext = {
    params: Record<string, any>;
 ...
 */
export type A_TYPES__Workflow_Serialized = {
 ...
 */
export type A_TYPES__WorkflowStepContext_Storage<
