 ...
 */
export const A_CONSTANTS__INSPECTOR_ENV_VARIABLES = {
    /**
...
export const A_CONSTANTS__INSPECTOR_ENV_VARIABLES_ARRAY = [
 ...
 */
export enum A_InspectorFeatures {
 ...
 */
export enum A_InspectorMessageType {
    Auth = 'auth',
    AuthOk = 'auth-ok',
    AuthFail = 'auth-fail',
    Command = 'command',
...
export const A_CONSTANTS__INSPECTOR_DEFAULT_HOST = '127.0.0.1';
/** Default inspector port when none is configured (0 = OS-assigned). */
export const A_CONSTANTS__INSPECTOR_DEFAULT_PORT = 0;
