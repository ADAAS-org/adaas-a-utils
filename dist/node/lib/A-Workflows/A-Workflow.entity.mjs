...
import { A_Entity, A_Scope, A_Feature, A_Error, A_Context } from '@adaas/a-concept';
...
import { A_WorkflowContextKey, A_Workflow_Status, A_WorkflowStepErrorBehavior, A_WorkflowEvent } from './A-Workflows.constants';

let A_Workflow = class extends A_Entity {
  constructor() {
    super(...arguments);
  ...
  get isProcessed() {
    return this._status === A_Workflow_Status.COMPLETED || this._status === A_Workflow_Status.FAILED;
  }
...
export { A_Workflow };
//# sourceMappingURL=A-Workflow.entity.mjs.map
//# sourceMappingURL=A-Workflow.entity.mjs.map