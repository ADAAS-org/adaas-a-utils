...
exports.A_SignalState = class A_SignalState extends aConcept.A_Fragment {
  /**
  ...
  set(param1, param2) {
    const signal = param1 instanceof ASignal_entity.A_Signal ? param1.constructor : param1;
    const value = param1 instanceof ASignal_entity.A_Signal ? param1 : param2;
    this._prevState.set(signal, this._state.get(signal));
    this._state.set(signal, value);
  }
  get(param) {
    const signal = param instanceof ASignal_entity.A_Signal ? param.constructor : param;
  ...
  toVector() {
    ...
    return new ASignalVector_entity.A_SignalVector(vector, this.structure);
  }
  /**
...
//# sourceMappingURL=A-SignalState.context.js.map
//# sourceMappingURL=A-SignalState.context.js.map